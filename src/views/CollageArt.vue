  ...
  <div class="collage-page">
    ...
    <section class="page-section" id="art">
      ...
      <div class="products-grid">
        ...
        <div class="product-item">
          <img src="/img/examplewashi.jpg" alt="Art on product" class="product-img" />
        </div>
        <div class="product-item">
          <img src="/img/exampleproduct (4).png" alt="Art on product" class="product-img" />
        </div>
        <div class="product-item product-item--tall">
          <img src="/img/exampleproduct (1).png" alt="Art on product" class="product-img" />
        </div>
         <div class="product-item">
          <img src="/img/exampleproducto.jpg" alt="Art on product" class="product-img" />
        </div>
      </div>
